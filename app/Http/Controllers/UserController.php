    ...
    public function api()
    {
        ...
        return DataTables::of($users)
            ->addColumn('action', function ($user) {
                return "
                    <a href='#' onclick='edit(".$user->id.")' title='Edit User'><i class='icon-pencil mr-1'></i></a>
                    <a href='#' onclick='remove(".$user->id.")' class='text-danger' title='Hapus User'><i class='icon-remove'></i></a>";
            })
