...
class BusinessController extends Controller
{
    ...
    public function api()
    {
        ...
        return DataTables::of($business)
            ...
            ->addColumn('action', function ($p) {
                return "
                    <a  href='" . route($this->route . 'edit', $p->id) . "'  title='Edit List'><i class='icon-pencil mr-1'></i></a>
                    <a href='#' onclick='remove(" . $p->id . ")' class='text-danger' title='Hapus List'><i class='icon-remove'></i></a>";
            })
    ...
    public function index()
    {
        ...
        return view('business.list.index', compact('title', 'route'));
    }
    ...
    public function create()
    {
        ...
        return view('business.list.create', compact('title', 'route', 'categories'));
    }
