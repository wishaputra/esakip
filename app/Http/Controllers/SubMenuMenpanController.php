...
class SubMenuMenpanController extends Controller
{
    public function api_submenu_menpan(Request $request)
    {
        ...
        return DataTables::of($menu)
            ->addColumn('submenu_count', function ($p) {
                ...
                return "<a  href='" . route('setup.submenu2_menpan.index') . "?sub_menu_id=" . $p->id . "'  title='Sub Menu'>" . $count . "</a>";
            })
    ...
    public function index(Request $request)
    {
        ...
        return view('submenu_menpan.index', compact('title', 'menu_id'));
    }
