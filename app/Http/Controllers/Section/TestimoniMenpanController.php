...
class TestimoniMenpanController extends Controller
{
    protected $route  = "setup.section.testimoni.";
    public function api_testimoni_menpan()
    {
    ...
    public function index()
    {
        ...
        return view('section.testimoni_menpan.index', compact('title', 'route', 'txt'));
    }
