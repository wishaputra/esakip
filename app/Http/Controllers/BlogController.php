...
class BlogController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('posts.index', compact('title', 'route', 'txt'));
    }
    ...
    public function create()
    {
        ...
        return view('posts.create', compact('title', 'route', 'categories'));
    }
    ...
    public function edit(Post $post)
    {
        ...
        return view('posts.edit', compact('title', 'route', 'post', 'categories'));
    }
