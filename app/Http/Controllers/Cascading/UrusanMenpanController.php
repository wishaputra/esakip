...
class UrusanMenpanController extends Controller
{
    public function api_urusan_menpan (Request $request)
    {
        ...
        return DataTables::of($urusan)
            ->addColumn('urusan_indikator_count', function ($p) {
                ...
                return "<a  href='".route('setup.urusan_menpan_indikator.index')."?id_urusan=".$p->id."'  title='Indikator Urusan'>".$count."</a>";
            })
     ...
     public function getSasaranByTahun($id)
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.urusan_menpan.index', compact('tahun','sasaran'));
    }
