...
class ProgramMenpanIndikatorController extends Controller
{
    public function api_program_menpan_indikator(Request $request)
    {
        ...
        return DataTables::of($program_indikator)
            ->addColumn('program_nilai_count', function ($p) {
                ...
                return "<a  href='".route('setup.program_menpan_nilai.index')."?id_indikator_program=".$p->id."'  title='Nilai Program'>".$count."</a>";
            })
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.program_menpan_indikator.index', compact('tahun','program','id_program'));
    }
