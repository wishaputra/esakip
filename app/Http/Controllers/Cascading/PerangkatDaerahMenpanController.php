...
class PerangkatDaerahMenpanController extends Controller
{
    public function api_perangkat_daerah_menpan(Request $request)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.perangkat_daerah_menpan.index', compact('tahun','opd'));
    }
