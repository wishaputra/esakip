...
class SasaranMenpanNilaiController extends Controller
{
    public function api_sasaran_menpan_nilai(Request $request)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.sasaran_menpan_nilai.index', compact('indikator','id_indikator'));
    }
