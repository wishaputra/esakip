...
class TujuanMenpanNilaiController extends Controller
{
    public function api_tujuan_menpan_nilai(Request $request)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.tujuan_menpan_nilai.index', compact('indikator','id_indikator_tujuan'));
    }
