...
class SasaranMenpanController extends Controller
{
    public function api_sasaran_menpan(Request $request)
    {
        ...
        return DataTables::of($sasaran)
            ->addColumn('sasaran_indikator_count', function ($p) {
                ...
                return "<a  href='".route('setup.sasaran_menpan_indikator.index')."?id_sasaran=".$p->id."'  title='Indikator Sasaran'>".$count."</a>";
            })
     ...
     public function getTujuanByTahun($id)
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.sasaran_menpan.index', compact('tahun','tujuan'));
    }
