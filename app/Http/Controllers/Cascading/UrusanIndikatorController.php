...
class UrusanIndikatorController extends Controller
{
    public function api(Request $request)
    {
        ...
        return DataTables::of($urusan_indikator)
            ->addColumn('urusan_nilai_count', function ($p) {
                ...
                return "<a  href='".route('setup.urusan_nilai.index')."?id_indikator=".$p->id."'  title='Nilai Urusan'>".$count."</a>";
            })
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.urusan_indikator.index', compact('urusan', 'id_urusan'));
    }
