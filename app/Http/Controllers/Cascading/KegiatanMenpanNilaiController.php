...
class KegiatanMenpanNilaiController extends Controller
{
    public function api_kegiatan_menpan_nilai(Request $request)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.kegiatan_menpan_nilai.index', compact('indikator','id_indikator_kegiatan','tahun'));
    }
