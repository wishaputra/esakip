...
class SasaranRenstraMenpanNilaiController extends Controller
{
    public function api_sasaran_renstra_menpan_nilai(Request $request)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.sasaran_renstra_menpan_nilai.index', compact('indikator','id_sasaran_renstra_indikator','tahun'));
    }
