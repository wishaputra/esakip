...
class UrusanOpdIndikatorController extends Controller
{
    public function api_opd_indikator(Request $request)
    {
        ...
        return DataTables::of($urusan_indikator)
            ->addColumn('urusan_nilai_count', function ($p) {
                ...
                return "<a  href='".route('setup.urusan_opd_nilai.index')."?id_indikator=".$p->id."'  title='Nilai Urusan'>".$count."</a>";
            })
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.urusan_opd_indikator.index', compact('urusan', 'id_urusan'));
    }
