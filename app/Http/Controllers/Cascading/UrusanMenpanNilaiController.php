...
class UrusanMenpanNilaiController extends Controller
{
    public function api_urusan_menpan_nilai(Request $request)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.urusan_menpan_nilai.index', compact('indikator','id_indikator','tahun'));
    }
