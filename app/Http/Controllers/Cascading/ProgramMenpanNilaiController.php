...
class ProgramMenpanNilaiController extends Controller
{
    public function api_program_menpan_nilai(Request $request)
    {
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.program_menpan_nilai.index', compact('indikator','id_indikator_program','tahun'));
    }
