...
class SasaranRenstraMenpanIndikatorController extends Controller
{
    public function api_sasaran_renstra_menpan_indikator(Request $request)
    {
        ...
        return DataTables::of($sasaran_renstra_indikator)
            ->addColumn('sasaran_renstra_nilai_count', function ($p) {
                ...
                return "<a  href='".route('setup.sasaran_renstra_menpan_nilai.index')."?id_sasaran_renstra_indikator=".$p->id."'  title='Nilai Sasaran Renstra'>".$count."</a>";
            })
    ...
    public function index(Request $request)
    {
        ...
        return view('cascading.sasaran_renstra_menpan_indikator.index', compact('sasaran_renstra','id_sasaran_renstra'));
    }
