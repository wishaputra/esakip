                            ...
                            <div class="card-body">
                                <form class="needs-validation"  id="form2" method="POST" autocomplete="off" novalidate>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control" value="{{ $txt->title }}">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="" class="col-form-label">Description</label>
                                        <input type="text" name="description" id="description" class="form-control" value="{{ $txt->description }}">
                                    </div>
