                ...
                <ul class="nav responsive-tab nav-material nav-material-white" id="v-pills-tab">
                    <li>
                        <a class="nav-link active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1">
                            <i class="icon icon-post"></i>Semua Data</a>
                    </li>
                    {{-- <li>
                            ...
                            <div class="card-body">
                                ...
                                @endphp
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <img width="400px" alt="" src="{{ $post->getImage() }}">
                                        <br>
                                        @endif
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select name="post_category_id" id="post_category_id" class="form-control" required>
                                            ...
                                            <option value="{{ $i->id }} " @if($post->post_category_id == $i->id) selected @endif>{{ $i->nama }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    {{-- <textarea id="test" name="test"> {!! Str::words(trim(strip_tags($post->content)),40, ' ...')!!}</textarea> --}}
