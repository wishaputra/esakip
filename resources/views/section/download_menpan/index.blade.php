        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white" id="v-pills-tab">
                    ...
                    <li>
                        <a class="nav-link " target="_blank" href="{{ route('main.download') }}">
                            <i class="icon icon-eye"></i>Preview</a>
                    </li>
...
<script>
    ...
    function edit(id){
        ...
        $.get("{{ route($route.'edit', ':id') }}".replace(':id', id), function(data){
            ...
            $('#frm_file').show();
            $('#frm_file').attr('href','{{URL::to("/")}}'+'/'+data.file);
    ...
    var table = $('#menu-table').dataTable({
        ...
        order: [1, 'asc'],
        ajax: {
            url: "{{ route('setup.section.download_menpan.api') }}",
            method: 'POST'
        },
        columns: [
