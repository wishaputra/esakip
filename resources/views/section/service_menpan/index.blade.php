                            ...
                            <div class="card-body">
                                <form class="needs-validation"  id="form2" method="POST" autocomplete="off" novalidate>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input readonly type="text" name="title" id="title" class="form-control" value="{{ $txt->title }}">
                                    </div>
                                    <div class="form-group col-md-12">
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" id="form" method="POST" autocomplete="off" novalidate>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" name="icon" id="icon" value="fas fa-" placeholder="fas fa-home" class="form-control">
