                            ...
                            <div class="card-body">
                                <form class="needs-validation" id="form2" method="POST" autocomplete="off" novalidate>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea readonly name="alamat" id="" cols="30" rows="3" class="form-control">{{ $txt->alamat }}</textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="" class="col-form-label">Telp</label>
                                        <input readonly type="text" name="telp" id="telp" class="form-control"
                                        value="{{ $txt->telp }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea readonly name="link_maps" id="" cols="30" rows="3" class="form-control">{{ $txt->link_maps }}</textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="" class="col-form-label">Text Submit Button</label>
                                        <input readonly type="text" name="text_button" id="text_button" class="form-control"
