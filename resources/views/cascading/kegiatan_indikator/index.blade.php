                ...
                <ul class="nav responsive-tab nav-material nav-material-white" id="v-pills-tab">
                    ...
                    <li>
                        <a class="nav-link " onclick="add()" href="#">
                            <i class="icon icon-plus-circle"></i>Tambah Indikator Kegiatan</a>
                    </li>
...
<script>
    ...
    function edit(id){
        ...
        $.get("{{ route('setup.kegiatan_indikator.edit', ':id') }}".replace(':id', id), function(data){
            $('#id').val(data.id);
            $('#kegiatan_indikator').val(data.kegiatan_indikator).focus();
            $('#form-modal').modal('show');
        }, "JSON").fail(function(){
            reload();
        });
    ...
    var table = $('#menu-table').dataTable({
        ...
        columns: [
            ...
            {data: 'kegiatan_indikator', name: 'kegiatan_indikator'},
