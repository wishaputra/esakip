                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" id="form_about" method="POST" autocomplete="off" novalidate>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input readonly type="text" name="title_about" id="title_about" class="form-control" value="{{ $about->title }}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea readonly id="content_about" name="content_about">{{ $about->content }}</textarea>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form class="needs-validation" id="form_link" method="POST" autocomplete="off" novalidate>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="" class="col-form-label">Title</label>
                                                <input readonly type="text" name="title_link" id="title_link" class="form-control" value="{{ $link->title }}">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form class="needs-validation" id="form_social" method="POST" autocomplete="off" novalidate>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="" class="col-form-label">Title</label>
                                                <input readonly type="text" name="title_social" id="title_social" class="form-control" value="{{ $social->title }}">
                                            </div>
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" id="form-modal-link-form" method="POST" autocomplete="off" novalidate>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input readonly type="number" name="frm_link_order" id="frm_link_order" class="form-control">
                    </div>


                    <div class="form-group col-md-12">
                        <label for="" class="col-form-label">Link</label>
                        <textarea readonly name="frm_link_content" id="frm_link_content"  ></textarea>
                    </div>
...
$('#form_social').on('submit', function (a) {
    ...
    var table_link = $('#link-table').dataTable({
        ...
        ajax: { 
            url: "{{ route($route.'api_link_menpan') }}",
            method: 'POST'
        },
        columns: [
    ...
    var table_social = $('#social-table').dataTable({
        ...
        ajax: {
            url: "{{ route($route.'api_social_menpan') }}",
            method: 'POST'
        },
        columns: [
            {data: 'id', name: 'id', orderable: false, searchable: false, align: 'center', className: 'text-center'},
