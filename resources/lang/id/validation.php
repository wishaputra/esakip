...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'content' => "Content",
        'title' => "Title",
        'frm_link_content' => "Link",
        'frm_link_order' => "Urutan",
        'frm_social_order' => "Urutan",
        'frm_social_icon' => "Icon",
        'frm_social_name' => "Name",
        'frm_social_link' => "Link",
    ],
];
